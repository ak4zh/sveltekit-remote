...
<header
  class="m-6 top-5 sticky border z-40 rounded-2xl flex justify-between items-center p-2 bg-card shadow-md dark:shadow-dark shadow-light"
>
  ...
  <div class="hidden lg:flex">
    <ToggleTheme />
    <Button size="sm" variant="default" aria-label="cta" href={siteConfig.cta}>
        CTA
    </Button>
  </div>
</header>
